...
class HomeEmptySliverWidget extends StatelessWidget {

  final String title;
final String subTitle;

  const HomeEmptySliverWidget({super.key, required this.title, required this.subTitle});
  @override
  Widget build(BuildContext context) {
    return  SliverFillRemaining(
      ...
      child: Column(
        ...
        children: [
          SvgAsset(
            Assets.images.svg.error.packageProcess,
            height: 100,
